...
export declare module EnterpriseChannelValidation {
    /**
     ...
     * @returns {Promise<ClaimsIdentity>} A valid ClaimsIdentity.
     */
    function authenticateChannelToken(authHeader: string, credentials: ICredentialProvider, channelId: string, channelService: string): Promise<ClaimsIdentity>;
    /**
